...
public class ConstantApp {
    ...
    public static final String ACTION_KEY_BROADCAST_TYPE = "broadcast_type";
    public static final String ACTION_KEY_ROOM_NAME = "ecHANEL";
    public static final String ACTION_KEY_U_ID = "mUID";
    public static final String INTENT_FILTER_STOP = "stop_broadcast";
}
